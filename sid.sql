...
--
-- Host: 127.0.0.1
-- Generation Time: 14-Maio-2019 às 19:15
...
INSERT INTO `alertas` (`data_hora`, `valor_medicao`, `id_cultura`, `id_variavel`, `numero_medicao`, `limite_inferior`, `limite_superior`) VALUES
('2019-05-13 17:45:48', '15.00', 2, 2, 2, '5', '15'),
('2019-05-13 22:45:38', '7.00', 9, 1, 7, '1', '2'),
('2019-05-13 22:46:20', '8.00', 9, 1, 8, '1', '2'),
('2019-05-13 22:47:26', '9.00', 9, 1, 9, '1', '2'),
('2019-05-13 22:47:58', '10.00', 9, 1, 10, '1', '2'),
('2019-05-13 22:49:16', '11.00', 9, 1, 11, '1', '2'),
('2019-01-01 00:00:00', '13.00', 6, 2, 14, '5', '100');
...
(0, 'palha', 'palhota', 1),
(1, 'palha\r\n', 'palhota', 1),
(2, 'batata', 'frita moh', 1),
(3, 'tomates', 'da tua avo', 1),
(6, 'damn', 'damn', 2),
(9, 'opah', 'opah', 2);
...
(1, 'ze3', 'ze', 'investigador'),
(2, 'luka', 'luka', 'investigador');
...
INSERT INTO `medicoes` (`numero_medicao`, `data_hora_medicao`, `valor_medicao`, `id_cultura`, `id_variavel`) VALUES
(1, '2019-05-13', '4.0000', 0, 1),
(2, '2019-05-13', '15.0000', 2, 2),
(3, '2019-05-13', '19.0000', 0, 2),
(7, '2019-05-13', '13.0000', 9, 1),
(8, '2019-05-13', '13.0000', 9, 1),
(9, '2019-05-13', '13.0000', 9, 1);
...
('2019-05-12 21:33:51', ' user_name : hugo email : olalalalla', 'insert', 'root@localhost', NULL),
('2019-05-12 21:47:45', ' user_name : iron email : hugopjoao@gmail.com', 'insert', 'root@localhost', NULL),
('2019-05-12 21:47:45', 'username: iron id_permissao: administrador', 'insert', 'root@localhost', NULL),
('2019-05-12 21:54:04', ' user_name : goncalito email : tiago.melo.neves@gmail.com', 'insert', 'root@localhost', NULL),
('2019-05-12 21:54:04', 'username: goncalito id_permissao: administrador', 'insert', 'root@localhost', NULL),
('2019-05-12 22:04:17', ' user_name : hugo email : hugopjoao@gmail.com', 'insert', 'root@localhost', NULL),
('2019-05-12 22:04:17', 'username: hugo id_permissao: administrador', 'insert', 'root@localhost', NULL),
('2019-05-12 22:26:33', ' user_name : goncalito23 email : tiago.melo.neves@gmail.com', 'insert', 'root@localhost', NULL),
('2019-05-12 22:26:33', 'username: goncalito23 id_permissao: administrador', 'insert', 'root@localhost', NULL),
('2019-05-12 22:34:26', ' user_name : ze email : ze3', 'insert', 'root@localhost', NULL),
('2019-05-12 22:34:26', 'username: ze id_permissao: investigador', 'insert', 'root@localhost', NULL),
('2019-05-12 22:40:25', ' user_name : auditor6 email : auditor2', 'insert', 'root@localhost', NULL),
('2019-05-12 22:40:25', 'username: auditor6 id_permissao: auditor', 'insert', 'root@localhost', NULL),
('2019-05-12 22:45:32', ' user_name : isqueiro email : tabaco', 'insert', 'root@localhost', NULL),
('2019-05-12 22:45:32', 'username: isqueiro id_permissao: auditor', 'insert', 'root@localhost', NULL),
('2019-05-12 22:55:41', ' user_name : luiscarlos email : carlos', 'insert', 'root@localhost', NULL),
('2019-05-12 22:55:41', 'username: luiscarlos id_permissao: auditor', 'insert', 'root@localhost', NULL),
('2019-05-13 03:59:43', ' user_name : joaop email : joaop', 'insert', 'root@localhost', NULL),
('2019-05-13 03:59:43', 'username: joaop id_permissao: auditor', 'insert', 'root@localhost', NULL),
('2019-05-13 17:24:29', 'id_investigador: 1 email: ze3', 'insert', 'root@localhost', NULL),
('2019-05-13 17:24:43', 'id_cultura: 0 nome_cultura: palha', 'insert', 'root@localhost', NULL),
('2019-05-13 17:25:08', 'id_cultura: 1 nome_cultura: palha\r\n', 'insert', 'root@localhost', NULL),
('2019-05-13 17:25:20', 'id_cultura: 2 nome_cultura: batata', 'insert', 'root@localhost', NULL),
('2019-05-13 17:25:30', 'id_cultura: 3 nome_cultura: tomates', 'insert', 'root@localhost', NULL),
('2019-05-13 17:37:07', 'id_variavel : 1 nome : ph', 'insert', 'root@localhost', NULL),
('2019-05-13 17:37:07', 'id_variavel : 2 nome : luz', 'insert', 'root@localhost', NULL),
('2019-05-13 17:38:16', 'limite_inferior: 5.00 limite_superior: 15.00 id_variavel: 2 id_cultura: 2', 'insert', 'root@localhost', NULL),
('2019-05-13 17:38:16', 'limite_inferior: 1.00 limite_superior: 99.00 id_variavel: 1 id_cultura: 2', 'insert', 'root@localhost', NULL),
('2019-05-13 17:38:29', 'limite_inferior: 4.00 limite_superior: 44.00 id_variavel: 2 id_cultura: 0', 'insert', 'root@localhost', NULL),
('2019-05-13 17:45:37', 'numero_medicao: 1 data_hora_medicao: 2019-05-13 18:45:37 valor_medicao: 4.0000 id_cultura: 0 id_variavel: 1', 'insert', 'root@localhost', NULL),
('2019-05-13 17:45:48', 'numero_medicao: 2 data_hora_medicao: 2019-05-13 18:45:48 valor_medicao: 15.0000 id_cultura: 2 id_variavel: 2', 'insert', 'root@localhost', NULL),
('2019-05-13 17:46:03', 'numero_medicao: 3 data_hora_medicao: 2019-05-13 18:46:03 valor_medicao: 19.0000 id_cultura: 0 id_variavel: 2', 'insert', 'root@localhost', NULL),
('2019-05-13 20:53:19', ' user_name : luka email : luka', 'insert', 'root@localhost', NULL),
('2019-05-13 20:53:19', 'id_investigador: 2 email: luka', 'insert', 'root@localhost', NULL),
('2019-05-13 20:53:19', 'username: luka id_permissao: investigador', 'insert', 'root@localhost', NULL),
('2019-05-13 20:54:39', 'id_cultura: 6 nome_cultura: damn', 'insert', 'root@localhost', NULL),
('2019-05-13 20:54:54', 'id_cultura: 9 nome_cultura: opah', 'insert', 'root@localhost', NULL),
('2019-05-13 20:55:29', 'limite_inferior: 1.00 limite_superior: 2.00 id_variavel: 1 id_cultura: 9', 'insert', 'root@localhost', NULL),
('2019-05-13 20:55:29', 'limite_inferior: 5.00 limite_superior: 100.00 id_variavel: 2 id_cultura: 6', 'insert', 'root@localhost', NULL),
('2019-05-13 20:56:04', 'numero_medicao: 4 data_hora_medicao: 2019-05-13 21:56:04 valor_medicao: 2.0000 id_cultura: 6 id_variavel: 1', 'insert', 'root@localhost', NULL),
('2019-05-13 20:56:04', 'numero_medicao: 5 data_hora_medicao: 2019-05-13 21:56:04 valor_medicao: 50.0000 id_cultura: 9 id_variavel: 2', 'insert', 'root@localhost', NULL),
('2019-05-13 21:05:56', 'numero_medicao: 4 data_hora_medicao: 2019-05-13 21:56:04 valor_medicao: 2.0000 id_cultura: 6 id_variavel: 1', 'delete', 'root@localhost', NULL),
('2019-05-13 21:16:11', 'numero_medicao: 5 data_hora_medicao: 2019-05-13 21:56:04 valor_medicao: 50.0000 id_cultura: 9 id_variavel: 2', 'delete', 'root@localhost', NULL),
('2019-05-13 22:45:38', 'numero_medicao: 7 data_hora_medicao: 2019-05-13 23:45:38 valor_medicao: 13.0000 id_cultura: 9 id_variavel: 1', 'insert', 'root@localhost', NULL),
('2019-05-13 22:46:20', 'numero_medicao: 8 data_hora_medicao: 2019-05-13 23:46:20 valor_medicao: 13.0000 id_cultura: 9 id_variavel: 1', 'insert', 'root@localhost', NULL),
('2019-05-13 22:47:26', 'numero_medicao: 9 data_hora_medicao: 2019-05-13 23:47:26 valor_medicao: 13.0000 id_cultura: 9 id_variavel: 1', 'insert', 'root@localhost', NULL),
('2019-05-13 22:47:58', 'numero_medicao: 10 data_hora_medicao: 2019-05-13 23:47:58 valor_medicao: 13.0000 id_cultura: 9 id_variavel: 1', 'insert', 'root@localhost', NULL),
('2019-05-13 22:49:16', NULL, 'insert', 'root@localhost', NULL),
('2019-05-13 22:53:21', 'numero_medicao: 11 data_hora_medicao: 0000-00-00 valor_medicao: 13.0000 id_cultura: 9 id_variavel: 1', 'delete', 'root@localhost', NULL),
('2019-05-13 22:53:50', 'numero_medicao: 12 data_hora_medicao: 2019-10-01 valor_medicao: 15.0000 id_cultura: 6 id_variavel: 1', 'insert', 'root@localhost', NULL),
('2019-05-13 22:54:54', 'numero_medicao: 12 data_hora_medicao: 2019-10-01 valor_medicao: 15.0000 id_cultura: 6 id_variavel: 1', 'delete', 'root@localhost', NULL),
('2019-05-13 23:28:07', 'numero_medicao: 13 data_hora_medicao: 2019-05-01 valor_medicao: 24.0000 id_cultura: 6 id_variavel: 1', 'insert', 'root@localhost', NULL),
('2019-05-13 23:30:11', 'numero_medicao: 14 data_hora_medicao: 2019-01-01 valor_medicao: 13.0000 id_cultura: 6 id_variavel: 2', 'insert', 'root@localhost', NULL),
('2019-05-13 23:32:22', 'numero_medicao: 13 data_hora_medicao: 2019-05-01 valor_medicao: 24.0000 id_cultura: 6 id_variavel: 1', 'delete', 'root@localhost', NULL),
('2019-05-13 23:32:45', 'numero_medicao: 14 data_hora_medicao: 2019-01-01 valor_medicao: 13.0000 id_cultura: 6 id_variavel: 2', 'delete', 'root@localhost', NULL),
('2019-05-13 23:32:47', 'numero_medicao: 10 data_hora_medicao: 2019-05-13 valor_medicao: 13.0000 id_cultura: 9 id_variavel: 1', 'delete', 'root@localhost', NULL);
...
(1, 'hugo', 'ola', 'olalalalla'),
(7, 'iron', 'cinzeiro', 'hugopjoao@gmail.com'),
(8, 'goncalito', 'palavrote', 'tiago.melo.neves@gmail.com'),
(9, 'hugo', 'palavra', 'hugopjoao@gmail.com'),
(10, 'goncalito23', 'palavra', 'tiago.melo.neves@gmail.com'),
(11, 'ze', 'ze2', 'ze3'),
(12, 'auditor6', 'auditor2', 'auditor2'),
(13, 'isqueiro', 'weed', 'tabaco'),
(14, 'luiscarlos', 'luis', 'carlos'),
(15, 'joaop', 'joaop', 'joaop'),
(16, 'luka', 'luka', 'luka');
...
('iron', 'administrador'),
('goncalito', 'administrador'),
('hugo', 'administrador'),
('goncalito23', 'administrador'),
('ze', 'investigador'),
('auditor6', 'auditor'),
('isqueiro', 'auditor'),
('luiscarlos', 'auditor'),
...
INSERT INTO `variaveis_medidas` (`limite_inferior`, `limite_superior`, `id_variavel`, `id_cultura`) VALUES
('5.00', '15.00', 2, 2),
('1.00', '99.00', 1, 2),
('4.00', '44.00', 2, 0),
('1.00', '2.00', 1, 9),
...
--
ALTER TABLE `medicoes`
  MODIFY `numero_medicao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
